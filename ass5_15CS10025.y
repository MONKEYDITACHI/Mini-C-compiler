        ...
        | postfix_expression '['expression']'
          {
              ...
              $$ = $1;
              if(!($$.isArrayType)) { //This case appears if postfix_exp was identifier thus it's the case from aho book where L -> id [num]
...
cast_expression:
        ...
        ;
// so far array/pointer ofset is only calculated dereferencing is done on the basis of use 
//classic expression evaluation rules from book in this part-------------------------------------------------------------
// in these rules if array or pointer is find it is not propogated-to make life easier while assignment in assignment
...
//Binary expression from here, hence truelist's, goto's and backpatching stuff-------------------------------------------------
...
direct_declarator:
        ...
        | direct_declarator '[' type_qualifier_list_opt assignment_expression_opt ']'
          { 
              ...
              int isMatrix = $1.type->isMatrix;// check Matrix type
              if($4.loc == NULL) {
                ...
                $$ = $1;
                $$.type->isMatrix=isMatrix; //set type if matrix
              }
          }
...
initializer_row_list:
	  ...
	  |	initializer_row_list ';' initializer_list
	  	{
